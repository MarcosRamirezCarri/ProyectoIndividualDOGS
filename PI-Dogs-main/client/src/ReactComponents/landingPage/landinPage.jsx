        ...
        <div className={style.containerButton}>
            ...
            <h2 className={style.containerWords1}>Where you can find your next life companion!</h2>
                ...
                <div className={style.containerWords2}>
                 <a target='_blank' href='https://github.com/MarcosRamirezCarri'>        <img className={style.image} src={gitHub} alt=' ' />
                </a>
                <a target='_blank' href='https://www.linkedin.com/in/marcos-ramirez-b8bb77253/'>
